        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h3 class="text-2xl leading-6 font-large text-indigo-900 mb-4">{{$checklist->title}}</h3>
                    ...
                    <p class="border-t border-1 pt-3">{!! trans_choice('checklist.delete_are_you_sure', $checklist->todos->count()) !!}</p>
